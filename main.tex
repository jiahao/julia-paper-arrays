...
statically or not. Therefore users are free to reason about
...
view(a::DenseArray, I::Subs...) =
    (shp = vshape(a, I...);
     make_view(a, restrict_crank(contrank(a, I...), shp), shp, I...))
\end{verbatim}
}
...
%Husbands, P.J.R. 1999. Interactive Supercomputing. PhD Thesis, Department of Electrical Engineering and Computer Science, Massachusetts Institute of Technology.



In this syntax, array dimensions were listed as parallel with the *p notation.  Indexing
lead to questions of whether to take the first instance of *p as the  parallel dimension,
the last instance of *p, or perhaps the final dimension.
