...
Language & Dispatch ratio & Choice ratio \\
\hline \hline
Gwydion    & 1.74 & 18.27 \\
\hline
OpenDylan  & 2.51 & 43.84 \\
\hline
CMUCL      & 2.03 &  6.34 \\
\hline
SBCL       & 2.37 & 26.57 \\
...
\end{center}
\caption{
Comparison of Julia (1132 functions exported from the \code{Base} library)
to results for other multiple dispatch languages \cite{Muschevici:2008}.
}
\end{figure}
