...
\authorinfo{Jeff Bezanson \and Jiahao Chen \and Keno Fischer \and Stefan Karpinski \and Viral Shah  \and Alan Edelman}
  ...
  { bezanson@csail.mit.edu, jiahao@mit.edu, kfischer@college.harvard.edu, stefan.karpinski@gmail.com, viral@mayin.org, edelman@mit.edu }
...
\marginpar{This is a great quote. }
\marginpar{ I wonder, however, if this quote was a victim
of the more limited approaches of 40 years ago.  While I'm sure it's always true
that users will continue to innovate and surprise, I bet we can plan for much more flexibility today!}
...
elements into memory addresses 
...
Three \framebox{four?} specific challenges can be identified:

\begin{enumerate}

\item{\bf Efficiency:} Code that \framebox{ operates on the dimension sizes} \marginpar{ right words?} needs to be
...
\item{\bf Flexibility:} Some applications require arrays of dynamic
...
\item {\bf  Specialization:} Programs may wish to treat arrays with
different numbers of dimensions very differently. A vector---an intrinsically
one-dimensional object-- can be  conceptually very different from an $N\times1$
...
method dispatch).
 ...
 \item {\bf Generalization:} It is often desirable to create abstractions
that apply to all arrays or a very large class of arrays.  Very powerful typing mechanisms
allow for this

\end{enumerate}

These three \framebox{four} factors together call for both static and dynamic analyses of
...
%% I see 1--2 as a dimension, and 3--4 as a dimension, am I wrong?
%% Let's discuss
...
[ Alan: Rank limits is one of the duller things, hardly seems even worthy of the word
``strategy''  -- All in all, I'd like to see this refactored as fitting into contrasts with Julia,
even as hints now with fuller explanations later  ]
