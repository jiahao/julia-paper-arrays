...
These languages support efficient libraries
...
leverage the static semantics of their host langangues to
...
implementations. The Star-P system \cite{parry} \cite{Choy05parallelmatlab}
