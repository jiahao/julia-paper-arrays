...
%TODO Static arrays are conceptually simple and yet afford nontrivial compiler design challenges for efficient implementation, such as common subexpression elimination for computing strides in offset computations.

%TODO Find some nice description of Fortran compilers about compiler-level optimizations for array indexing computations.
...
%In C you can do A[][], or *A and do the strides and indexing manually, or **A which is an array of arrays which is NOT isomorphic to *A.
...
The authors gratefully acknowledge the enthusiastic participation of the Julia developer community for many stimulating discussions on the topic of array implementations in the Julia language.
