...
For purposes of this paper an N-d
array is a tuple of a memory buffer, shape, and possibly strides
...
%TODO Keno points out this last thing is no longer true (at least in C99)
...
%Jeff: pattern matching in Mathematica results in no data abstraction---
%there is no difference between being a list and
%being something represented as a list.
...
%TODO ease of writing code for arrays of arbitrary rank?
