...
% not a separate mechanism - smooth path from OOP to generic, symbolic prog.
% users get used to writing multi-method signatures, and as they write
% more elaborate ones they smoothly transition to using compile-time
% abstraction (without realizing it?).
