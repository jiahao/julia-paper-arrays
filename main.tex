...
of key array operators \marginpar{Which operators? reshape? indexing? others?}  --- not just to organize the functionality into
classes.
...
post-permutations to swap the desired index with the last index. Howevver,
...
but has the cost of introducing repitition in the code
